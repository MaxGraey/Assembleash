        ...
        return (
            <ButtonToolbar style={{ padding: '0', margin: '20px 20px 12px 15px' }}>
                ...
                <div className="fork-me pull-right">
                    <a title="Fork me on GitHub" target="_blank" href="https://github.com/MaxGraey/Assembleash">
                        <svg ariaHidden="true" className="github-octicon-mark" version="1.1" viewbox="0 0 16 16" width="32" height="32">
